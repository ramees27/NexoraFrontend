...
import VideoCallRoom from './Components/Counselor/Booking/VideoCallRoom'
import VideoCall from './Components/Counselor/Booking/VideoCallRoom'
  ...
  return (
    <Routes>
      ...
      <Route path='/counselor' element={<COutlet />}>
       ...
       {/* <Route path="/video-call/:bookingId/:userId" element={<VideoCall />} /> */}
